...
int Clock_PrintBuffDate(double clock, char *buffer, size_t len)
{
   ...
   if (len >= 14) {
      sprintf(buffer, "%04ld%02d%02d%02d%02d%02.0f", (long int) year, month, day, hour,
              min, sec);
   } else if (len == 12) {
      sprintf(buffer, "%04ld%02d%02d%02d%02d", (long int) year, month, day, hour, min);
   } else if (len == 10) {
      sprintf(buffer, "%04ld%02d%02d%02d", (long int) year, month, day, hour);
   } else if (len == 8) {
      sprintf(buffer, "%04ld%02d%02d", (long int) year, month, day);
   } else if (len == 6) {
      sprintf(buffer, "%04ld%02d", (long int) year, month);
   } else if (len == 4) {
