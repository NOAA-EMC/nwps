...
#AW        &runWaveModel(%CG);
#AW
#AW        &renameFilesWithSuffix($dateSuffix,"PRT|spec2d|TAB|CGRID");
#AW	# 06/24/2011: Moving SWAN ouput files for ${OUTPUTdir}/partition directory 
#AW#        my $cgxx="CG".$CG{CGNUM}; 
#AW#        system(" mkdir -p  ${OUTPUTdir}/partition/${cgxx}");
#AW#        &mvFiles("${OUTPUTdir}/partition/${cgxx}","PRT"); 
#AW        &mvFiles("${OUTPUTdir}/spectra/","spec2d");
#AW
#AW	# 05/17/2011: Moving SWAN ouptu files for ${OUTPUTdir}/grid directory
#AW        &mvFiles("${OUTPUTdir}/grid/","CGRID");
#AW
#AW        &archiveFiles("PRINT","${RUNdir}");
...
# = =RPH ADDED to get the bathymetry for every site (wfo) in SetupCG.pm
...
# Calling program/subroutine: SetupCG.pm/getWW3Files
...
# Calling program/subroutine: SetupCG.pm/getWW3InputFiles
...
# Calling program/subroutine: SetupCG.pm/makeInputCGx
