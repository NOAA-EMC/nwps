...
# === Find global max wind speed once (to fix colorbar scale) ===
...
unitconvert = 1/0.514444  # m/s -> knots
...
for tstep in range(TSTART, (int(TEND)+1)):
    ...
    figtitle = 'NWPS Wind (knots) \n Hour ' + str(forecastTime) + ' (' + \
               str(date.hour).zfill(2) + 'Z' + str(date.day).zfill(2) + \
