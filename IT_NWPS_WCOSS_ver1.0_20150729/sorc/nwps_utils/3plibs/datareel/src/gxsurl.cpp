...
// array. Returns false if no protocol is found in the URL. 
{
  ...
  // Example: http://my.datareel.com/leaving.php?http://www.datareel.com
  gxString sbuf = url;
...
// false if the url does not contain a username or password.
{
  ...
  // 09/10/2006: Must account for dynamic pages and targets
  // Example: http://username:passwd@my.datareel.com/leaving.php?http://www.datareel.com
  sbuf.DeleteAfterIncluding("?");
  sbuf.DeleteAfterIncluding("#");
...
// "dir" and "file" variables.
{
  ...
  if(sbuf[sbuf.length()-1] == '/') {
    ...
    // Example: http://www.datareel.com/docs/
    dir = path;
  ...
  // 09/10/2006: Must account for dynamic pages and targets
  // Example: <a href="/leaving.php?http://www.datareel.com>
  gxString dir_buf = sbuf;
  ...
  // www.datareel.com/?ContentID=2083
  if(dir_buf == "/") {
    dir = "/";
    return has_file = 0;
  }
  ...
  // www.datareel.com/documents/?ContentID=2083
...
int gxsURL::SetDefaultProto(gxString &url)
{
  ...
  // 09/10/2006: Must account for dynamic pages and targets
  // Example: /leaving.php?http://www.datareel.com
  gxString sbuf = url;
  sbuf.DeleteAfterIncluding("?");
  sbuf.DeleteAfterIncluding("#");
