...
11/30/2009: Added stack size set fix for POSIX threads that do not have the 
...
// POSIX 1003.1c 1995 thread standard
  ...
  // 11/30/2009: We are using POSIX threads but do not have PTHREAD_STACK_MIN
  // value defined.
  if(thread->stack_size > (gxStackSizeType)0) {
