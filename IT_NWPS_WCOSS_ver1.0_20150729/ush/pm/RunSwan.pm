...
#    if($HOTSTART eq 'TRUE') {
	...
	if ((( -e "${RUNdir}/${hottime[0]}" ) && ( int( -M "${RUNdir}/${hottime[0]}" ) < 1 )) || 
	    ((-e "${RUNdir}/${hottime[0]}-001" ) && ( int( -M "${RUNdir}/${hottime[0]}-001" ) < 1))) {
...
#XXXXXXXXXXXXX  RPH
print "In RunSwan  USERDELTAC: $USERDELTAC";
