...
do
  ...
  do
    ...
    if [ -f ${dset} ]; then
      ...
      # Transfer to RZDM
      scp ${dset} waves@emcrzdm:/home/www/polar/nwps/para/images/rtimages/${wfo}/nwps/${cgnum}/

      # Extract on RZDM
      ssh waves@emcrzdm "cd /home/www/polar/nwps/para/images/rtimages/${wfo}/nwps/${cgnum}/; tar -xf plots_${wfo}_${cgnum}.tar.gz"

      # Remove tarball on RZDM
      ssh waves@emcrzdm "cd /home/www/polar/nwps/para/images/rtimages/${wfo}/nwps/${cgnum}/; rm plots_${wfo}_${cgnum}.tar.gz"
