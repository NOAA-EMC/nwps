...
export DEFAULT_STOFSHOURS="144"
export DEFAULT_STOFSTIMESTEP="1"
export DEFAULT_STOFSUSEICEMASK="FALSE"
...
if [ "${STOFSUSEICEMASK}" == "" ]; then export STOFSUSEICEMASK=${DEFAULT_STOFSUSEICEMASK}; fi

# Sea ice domain
# SEAICEDOMAIN="LON LAT 0. NX NY EW-RESOLUTION NS-RESOLUTION"
export DEFAULT_SEAICEDOMAIN="262.00 23.0 0. 682 370 0.029326 0.027027"
export DEFAULT_SEAICENX="683"
export DEFAULT_SEAICENY="371"
export DEFAULT_SEAICEHOURS="144"
export DEFAULT_SEAICETIMESTEP="1"

if [ "${SEAICEDOMAIN}" == "" ]; then export SEAICEDOMAIN="${DEFAULT_SEAICEDOMAIN}"; fi
if [ "${SEAICENX}" == "" ]; then export SEAICENX=${DEFAULT_SEAICENX}; fi
if [ "${SEAICENY}" == "" ]; then export SEAICENY=${DEFAULT_SEAICENY}; fi
if [ "${SEAICEHOURS}" == "" ]; then export SEAICEHOURS=${DEFAULT_SEAICEHOURS}; fi
if [ "${SEAICETIMESTEP}" == "" ]; then export SEAICETIMESTEP=${DEFAULT_SEAICETIMESTEP}; fi
